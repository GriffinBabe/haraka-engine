...
class Disconnection PROTOBUF_FINAL :
 ...
 public:
  ...
  ~Disconnection() override;
  explicit constexpr Disconnection(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void Connection::set_username(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Connection::set_password(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000002u;
...
template <typename ArgT0, typename... ArgT>
PROTOBUF_ALWAYS_INLINE
inline void Disconnection::set_reason(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
